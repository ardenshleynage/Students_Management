...
public class Add_Students extends javax.swing.JFrame {
     ...
     * @param controller
     */
    public Add_Students(Sm_Ctrl controller) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Ajoutez Étudiants");
        ...
        address_field.setBackground(new java.awt.Color(51, 102, 255));
        address_field.setFont(new java.awt.Font("sansserif", 0, 16)); // NOI18N
        address_field.setForeground(new java.awt.Color(0, 0, 0));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String address_input = address_field.getText().trim();
        String dobStr = date.getDateFormatString();

        if (l_name_input.isEmpty() || f_name_input.isEmpty() || phone_input.isEmpty() || email_input.isEmpty() || password_input.isEmpty() || address_input.isEmpty()) {
        ...
        try {
            boolean success = controller.addStudent(l_name_input, f_name_input, dob, email_input, phone, sex, address_input, LocalDate.now(), hashedPassword, 1);

            if (success) {
                JOptionPane.showMessageDialog(this, "Étudiant ajouté avec succès !");
                Sm_Ctrl contr = new Sm_Ctrl();
                this.dispose();
                Add_Students AsFrame = new Add_Students(contr);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new Add_Students(controllers).setVisible(true);
            }
        });
    }
