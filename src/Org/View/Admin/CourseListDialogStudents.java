 ...
 * @author an
 */
public class CourseListDialogStudents extends JDialog {
    public static void showDialog(JFrame parent, Long studentId, Sm_Ctrl controller) {
        List<Object[]> courses = controller.getStudentByCourse(studentId);
        
        if (courses.isEmpty()) {
            JOptionPane.showMessageDialog(parent, "Aucun cours trouvé pour cet Étudiant.");
            return;
        }
