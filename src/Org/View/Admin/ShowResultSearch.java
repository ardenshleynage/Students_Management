 ...
 * @author an
 */
public class ShowResultSearch extends javax.swing.JFrame {

    private final Sm_Ctrl controller;

    /**
     * Creates new form showResultSerch
     *
     * @param controller
     * @param student
     */
    public ShowResultSearch(Sm_Ctrl controller, Students_Entity student) {
        ...
        dashPanel.changerCouleurLabel2(Color.WHITE); // Rouge par exemple
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (selectedRow >= 0 && SwingUtilities.isLeftMouseButton(e)) {
                    ...
                    try {
                        ...
                        Students_Entity student = controller.findStudentByRegNumber(regNumb);
                        ...
                        if (student != null) {
                            ...
                            String address = jTable2.getValueAt(selectedRow, 9).toString(); // Adresse
...
//                            String gender = (sex == 1) ? "Masculin" : (sex == 2) ? "Féminin" : "Inconnu";
                            String message = String.format(
                                    ...
                                    regNumber, lname, fname, mail, dob, wtf, address, phone, regDate, access
                            );
                            ...
                            if (access.equals("Autoriser")) {
                                options = new Object[]{"Inscrire à un cours", "Afficher les cours", "Bloquer", "Modifier", "Supprimer", "Annuler"};
                            } else if (access.equals("Supprimer")) {
                                options = new Object[]{"Inscrire à un cours", "Afficher les cours", "Autoriser", "Modifier", "Restaurer", "Annuler"};
                            } else if (access.equals("Bloquer")) {
                                options = new Object[]{"Inscrire à un cours", "Afficher les cours", "Autoriser", "Modifier", "Supprimer", "Annuler"};
                            } else {
                                options = new Object[]{"Annuler"}; // Option par défaut si `statuts` a une valeur inattendue
                            }

                            int option = JOptionPane.showOptionDialog(
                                    ShowResultSearch.this,
                                    message,
                            ...
                            switch (option) {
                                case 0:
                                    String d_o_b2 = String.valueOf(student.getDob());
                                    Sm_Ctrl cre = new Sm_Ctrl();
                                    dispose();
                                    Add_Classes_Students ACTFrame = new Add_Classes_Students(number, lname, fname, d_o_b2, cre);
                                ...
                                case 1: // "Bloquer" ou "Autoriser"
                                    CourseListDialogStudents.showDialog(ShowResultSearch.this, student.getId(), controller);

                                    break;

                                case 2:
                                    if (access == "Autoriser") {
                                        controller.BlockStudents(student);
                                        JOptionPane.showMessageDialog(ShowResultSearch.this, "Étudiant bloqué avec succès !");
                                        Sm_Ctrl contra = new Sm_Ctrl();
                                        dispose();
                                        Dashboard_All_Students AllstudentsFrame = new Dashboard_All_Students(contra);
                                        AllstudentsFrame.setLocationRelativeTo(null);
                                        AllstudentsFrame.setVisible(true);
                                    } else {
                                        controller.AllowStudents(student);
                                        JOptionPane.showMessageDialog(ShowResultSearch.this, "Étudiant autorisé avec succès !");
                                        Sm_Ctrl contrx = new Sm_Ctrl();
                                        dispose();
                                        Dashboard_All_Students AllstudentsFrame = new Dashboard_All_Students(contrx);
                                        AllstudentsFrame.setLocationRelativeTo(null);
                                        AllstudentsFrame.setVisible(true);
                                    }
                                    break;
                                ...
                                case 3:
                                    dispose();
                                    String sexe = String.valueOf(student.getSex());
                                    String tel = String.valueOf(student.getPhone());
                                    String d_o_b = String.valueOf(student.getDob());
                                    Sm_Ctrl cx = new Sm_Ctrl();
                                    Updates_Students UpdateFrame = new Updates_Students(regNumber, number, lname, fname, mail, d_o_b, sexe, address, tel, password, cx);
                                    UpdateFrame.setLocationRelativeTo(null);
                                    UpdateFrame.setVisible(true);
                                    break;
                                case 4:
                                    if (access == "Autoriser" || access == "Bloquer") {
                                        DeleteStudentsQuestion(student);
                                    } else {
                                        controller.RestoreStudents(student);
                                        JOptionPane.showMessageDialog(ShowResultSearch.this, "Étudiant réstauré avec succès !");
                                        Sm_Ctrl contrc = new Sm_Ctrl();
                                        dispose();
                                        Dashboard_All_Students AllstudentsFrame = new Dashboard_All_Students(contrc);
                                        AllstudentsFrame.setLocationRelativeTo(null);
                                        AllstudentsFrame.setVisible(true);
                                    }
                                    break;
                            ...
                            JOptionPane.showMessageDialog(ShowResultSearch.this, "Erreur : l'l'étudiant sélectionné n'a pas pu être trouvé.", "Erreur", JOptionPane.ERROR_MESSAGE);
                        }
                    } catch (Exception ex) {
                        JOptionPane.showMessageDialog(ShowResultSearch.this, "Erreur lors de la récupération des données : " + ex.getMessage(), "Erreur", JOptionPane.ERROR_MESSAGE);
                    }
                }
            }
    ...
    private void DeleteStudentsQuestion(Students_Entity student) {
        // Show a dialog with Yes and No options
        int option = JOptionPane.showOptionDialog(
                null,
                "Voulez-vous réellement supprimez l'étudiant ?",
                "Confirmation",
    ...
    private void handleDeleteStudents(Students_Entity student) {
        boolean success = controller.SureDeleteStudents(student);

        if (success) {
            JOptionPane.showMessageDialog(this, "L'étudiant a été supprimés.", "Information", JOptionPane.INFORMATION_MESSAGE);
            Sm_Ctrl contrx = new Sm_Ctrl();
            dispose();
            Dashboard_All_Students AllstudentsFrame = new Dashboard_All_Students(contrx);
            AllstudentsFrame.setLocationRelativeTo(null);
            ...
            JOptionPane.showMessageDialog(this, "Erreur lors de la suppresion de l'étudiant.", "Erreur", JOptionPane.ERROR_MESSAGE);
        }
    }
        ...
        saveButton.addActionListener(event -> {
            ...
            if (!regnumb.isEmpty()) {
                ...
                if (student != null) {
                    ...
                    ShowResultSearch searchFrame = new ShowResultSearch(cx, student);
                    searchFrame.setLocationRelativeTo(null);
                    searchFrame.setVisible(true);

                } else {
                    JOptionPane.showMessageDialog(dialog,
                            "Aucun étudiant trouvé pour la recherche : " + regnumb,
    ...
    public void populateTable(Students_Entity student) {
        DefaultTableModel model = (DefaultTableModel) jTable2.getModel();
        model.setRowCount(0); // Effacer les anciennes données

        if (student == null) {
            String emptyMessage = "Aucun étudiant trouvé.";
            ...
            int rowNumber = 1;
            String statut = (student.getAccess() == 1) ? "Autoriser" : (student.getAccess() == 2) ? "Bloquer" : (student.getAccess() == 0) ? "Supprimer" : "Inconnu";
            String sex = (student.getSex() == 1) ? "Masculin" : (student.getSex() == 2) ? "Féminin" : "Inconnu";

            Object[] rowData = {
                rowNumber++, // Numéro de ligne
                student.getReg_number(),
                student.getId(),
    ...
    private void initComponents() {
        ...
        jLabel13.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                dispose();
                Dashboard_Trash_Students TrashstudentsFrame = new Dashboard_Trash_Students(contry);
                TrashstudentsFrame.setLocationRelativeTo(null);
                TrashstudentsFrame.setVisible(true);
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "#", "Matricule", "id", "Nom", "Prénom", "E-mail", "Date de naissance", "Statut", "Sexe", "Adresse", "Téléphone", "Date d'enregistrement", "Mots de passe"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowResultSearch.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                Students_Entity sd = new Students_Entity();
                new ShowResultSearch(controllers, sd).setVisible(true);
            }
        });
    }
