 ...
 * @author an
 */
public class Log_Sa_Admin extends javax.swing.JFrame {
     ...
     * @param controller
     */
    public Log_Sa_Admin(Sm_Ctrl controller) {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Org/Images/add_admin1.png"))); // NOI18N
        ...
        username_field.setBackground(new java.awt.Color(51, 102, 255));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String username_input = username_field.getText().trim();
        ...
        Super_Admin_Entity admin = controller.Login_Admin(username_input, hashedPassword);
        ...
        // Si la connexion réussit, ouvrir le tableau de bord
        dispose();
        Dashboard_Home DashboardFrame = new Dashboard_Home();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Log_Sa_Admin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new Log_Sa_Admin(controllers).setVisible(true);
            }
        });
    }
