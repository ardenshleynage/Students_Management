 ...
 * @author an
 */
public class Dashboard_Trash_Students extends javax.swing.JFrame {

    private final Sm_Ctrl controller;

    /**
     * Creates new form Dashboard_Trash_Students
     *
     * @param controller
     */
    public Dashboard_Trash_Students(Sm_Ctrl controller) {
    ...
    public void populateTable() {
        boolean NoStudents = controller.NoTrashStudents();
        ...
        if (NoStudents) {
            ...
            List<Students_Entity> StudentsList = controller.getAllTrashStudents();  // Fetch all people from the controller
        ...
        jTable2.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (selectedRow >= 0 && SwingUtilities.isLeftMouseButton(e)) {
                    try {
                        List<Students_Entity> Students = controller.getAllTrashStudents();
                        ...
                        if (student != null) {
                            ...
                            switch (option) {
                                case 0:
                                    EraseStudentsQuestion(student);
                                    break;
                                case 1:
                                    controller.RestoreStudents(student);
                                    JOptionPane.showMessageDialog(Dashboard_Trash_Students.this, "Étudiant réstauré avec succès !");
                                    populateTable();
                                    break;
                                case 2:
                                    break;
                            ...
                            JOptionPane.showMessageDialog(Dashboard_Trash_Students.this, "Erreur : l'l'étudiant sélectionné n'a pas pu être trouvé.", "Erreur", JOptionPane.ERROR_MESSAGE);
                        }
                    } catch (Exception ex) {
                        JOptionPane.showMessageDialog(Dashboard_Trash_Students.this, "Erreur lors de la récupération des données : " + ex.getMessage(), "Erreur", JOptionPane.ERROR_MESSAGE);
                    }
                }
            }
    ...
    private void EraseStudentsQuestion(Students_Entity student) {
        // Show a dialog with Yes and No options
        int option = JOptionPane.showOptionDialog(
                null,
                "Voulez-vous réellement supprimez définitivement l'étudiant ?",
                "Confirmation",
    ...
    private void handleEraseStudents(Students_Entity student) {
        boolean success = controller.SureEraseStudents(student);

        if (success) {
            JOptionPane.showMessageDialog(this, "L'étudiant  a été supprimés définitivement.", "Information", JOptionPane.INFORMATION_MESSAGE);
            populateTable();
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dashboard_Trash_Students.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new Dashboard_Trash_Students(controllers).setVisible(true);
            }
        });
    }
