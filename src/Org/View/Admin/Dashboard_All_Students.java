 ...
 * @author an
 */
public class Dashboard_All_Students extends javax.swing.JFrame {

    private final Sm_Ctrl controller;

    /**
     * Creates new form Dashboard_Students
     *
     * @param controller
     */
    public Dashboard_All_Students(Sm_Ctrl controller) {
    ...
    public void populateTable() {
        boolean NoStudents = controller.NoStudents();
        DefaultTableModel model = (DefaultTableModel) jTable2.getModel();
        model.setRowCount(0);

        if (NoStudents) {
            String emptyMessage = "Il n'y a pas d'étudiants, vérifier la corbeille.";
            ...
            List<Students_Entity> StudentsList = controller.getAllStudents();  // Fetch all people from the controller

            // Clear the existing rows
            int rowNumber = 1;

            for (Students_Entity student : StudentsList) {

                String statut = student.getAccess() == 1 ? "Autoriser" : student.getAccess() == 2 ? "Bloquer" : "Inconnu";
                String sex = student.getSex() == 1 ? "Masculin" : student.getSex() == 2 ? "Feminin" : "Inconnu";
                Object[] rowData = {
                    rowNumber++,
        ...
        jTable2.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (selectedRow >= 0 && SwingUtilities.isLeftMouseButton(e)) {
                    try {
                        List<Students_Entity> Students = controller.getAllStudents();
                        Students_Entity student = Students.get(selectedRow);

                        if (student != null) {
                            String regNumber = student.getReg_number();
                            String number = String.valueOf(student.getId());
                            ...
                            LocalDate regDate = student.getReg_date();
                            String password = student.getPassword();
                            int statuts = student.getAccess();
                            ...
                            String message = String.format(
                                    ...
                                    regNumber, lname, fname, mail, dob, gender, address, phone, regDate, statut
                            );

                            // Définir les options dynamiques en fonction du statut
                            Object[] options = (statuts == 1)
                                    ? new Object[]{"Inscrire  à un cours", "Afficher les cours", "Bloquer", "Modifier", "Supprimer", "Annuler"}
                                    : new Object[]{"Inscrire  à un cours", "Afficher les cours", "Autoriser", "Modifier", "Supprimer", "Annuler"};

                            int option = JOptionPane.showOptionDialog(
                                    Dashboard_All_Students.this,
                                    message,
                            ...
                            switch (option) {
                                ...
                                case 1: // "Bloquer" ou "Autoriser"
                                    CourseListDialogStudents.showDialog(Dashboard_All_Students.this, student.getId(), controller);
                                ...
                                case 2:
                                    if (statuts == 1) {
                                        ...
                                        JOptionPane.showMessageDialog(Dashboard_All_Students.this, "Étudiant bloqué avec succès !");
                                        populateTable();
                                    } else {

                                        controller.AllowStudents(student);
                                        JOptionPane.showMessageDialog(Dashboard_All_Students.this, "Étudiant autorisé avec succès !");
                                        populateTable();
                                    }
                                    break;
                            ...
                            JOptionPane.showMessageDialog(Dashboard_All_Students.this, "Erreur : l'l'étudiant sélectionné n'a pas pu être trouvé.", "Erreur", JOptionPane.ERROR_MESSAGE);
                        }
                    } catch (Exception ex) {
                        JOptionPane.showMessageDialog(Dashboard_All_Students.this, "Erreur lors de la récupération des données : " + ex.getMessage(), "Erreur", JOptionPane.ERROR_MESSAGE);
                    }
                }
            }
        ...
        saveButton.addActionListener(event -> {
            ...
            if (!regnumb.isEmpty()) {
                ...
                if (student != null) {
                    ...
                    ShowResultSearch searchFrame = new ShowResultSearch(cy,student);
...
// Nouvelle fenêtre "Result" pour afficher les détails
    /**
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "#", "Matricule", "id", "Nom", "Prénom", "E-mail", "Date de naissance", "Statut", "Sexe", "Adresse", "Téléphone", "Date d'enregistrement"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dashboard_All_Students.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new Dashboard_All_Students(controllers).setVisible(true);
            }
        });
    }
