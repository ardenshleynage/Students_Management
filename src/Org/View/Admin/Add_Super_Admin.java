...
public class Add_Super_Admin extends javax.swing.JFrame {
     ...
     * @param controller
     */
    public Add_Super_Admin(Sm_Ctrl controller) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (l_name_input.isEmpty() || f_name_input.isEmpty() || username_input.isEmpty() || password_input.isEmpty()) {
        ...
        controller.addAdmin(username_input, l_name_input, f_name_input, hashedPassword);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new Add_Super_Admin(controllers).setVisible(true);
            }
        });
    }
