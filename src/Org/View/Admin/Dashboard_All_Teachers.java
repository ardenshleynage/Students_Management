 ...
 * @author an
 */
public class Dashboard_All_Teachers extends javax.swing.JFrame {

    private final Sm_Ctrl controller;

    /**
     * Creates new form Dashboard_All_Teachers
     *
     * @param controller
     */
    public Dashboard_All_Teachers(Sm_Ctrl controller) {
    ...
    public void populateTable() {
        boolean NoTeachers = controller.NoTeachers();
        DefaultTableModel model = (DefaultTableModel) jTable2.getModel();
        model.setRowCount(0);

        if (NoTeachers) {
            String emptyMessage = "Il n'y a pas d'enseignants, vérifier la corbeille.";
            ...
            List<Teachers_Entity> TeachersList = controller.getAllTeachers();  // Fetch all people from the controller
        ...
        jTable2.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (selectedRow >= 0 && SwingUtilities.isLeftMouseButton(e)) {
                    try {
                        List<Teachers_Entity> Teachers = controller.getAllTeachers();
                        ...
                        if (teacher != null) {
                            ...
                            Object[] options = (statuts == 1)
                                    ? new Object[]{"Attribuer un cours", "Afficher les cours", "Bloquer", "Modifier", "Supprimer", "Annuler"}
                                    : new Object[]{"Attribuer un cours", "Afficher les cours", "Autoriser", "Modifier", "Supprimer", "Annuler"};

                            int option = JOptionPane.showOptionDialog(
                                    Dashboard_All_Teachers.this,
                                    message,
                                    "Détails de l'enseignants",
                            ...
                            switch (option) {
                                ...
                                case 1: // "Bloquer" ou "Autoriser"
                                    CourseListDialog.showDialog(Dashboard_All_Teachers.this, teacher.getId(), controller);
                                ...
                                case 2:
                                    if (statuts == 1) {
                                        ...
                                        JOptionPane.showMessageDialog(Dashboard_All_Teachers.this, "Enseignant bloqué avec succès !");
                                        populateTable();
                                    } else {

                                        controller.AllowTeachers(teacher);
                                        JOptionPane.showMessageDialog(Dashboard_All_Teachers.this, "Enseignant autorisé avec succès !");
                                        populateTable();
                                    }
                                    break;
                                ...
                                case 3:
                                    ...
                                    break;
                                case 4:
                                    DeleteTeachersQuestion(teacher);
                                    break;
                                case 5:
                                    break;
                            }
                        } else {
                            JOptionPane.showMessageDialog(Dashboard_All_Teachers.this, "Erreur : L'enseignant sélectionné n'a pas pu être trouvé.", "Erreur", JOptionPane.ERROR_MESSAGE);
                        }
                    } catch (Exception ex) {
                        JOptionPane.showMessageDialog(Dashboard_All_Teachers.this, "Erreur lors de la récupération des données : " + ex.getMessage(), "Erreur", JOptionPane.ERROR_MESSAGE);
                    }
                }
            }
    ...
    private void DeleteTeachersQuestion(Teachers_Entity teacher) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dashboard_All_Teachers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new Dashboard_All_Teachers(controllers).setVisible(true);
            }
        });
    }
