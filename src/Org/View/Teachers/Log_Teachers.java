 ...
 * @author an
 */
public class Log_Teachers extends javax.swing.JFrame {

    private final Sm_Ctrl controller;

    /**
     * Creates new form Log_Teachers
     *
     * @param controller
     */
    public Log_Teachers(Sm_Ctrl controller) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Teachers_Entity teacher = controller.Login_Teachers(regnumb_input, hashedPassword);
        Long id_teacher = controller.getTeachersIdByRegNumb(regnumb_input);
        System.out.println("id prof" + id_teacher);
        ...
        dispose();
        String id =String.valueOf(id_teacher);
        Dash_Teachers_Course DashboardFrame = new Dash_Teachers_Course(id,ctrx);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Log_Teachers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new Log_Teachers(controllers).setVisible(true);
            }
        });
    }
